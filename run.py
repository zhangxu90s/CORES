...
def loss_fn(code_inputs,nl_vec,code_vec):
    # ------- covariance loss -------
    ...
    cov_loss = covariance_loss(code_vec)
...
def train(args, model, tokenizer):
    ...
    for idx in range(args.num_train_epochs): 
        for step,batch in enumerate(train_dataloader):
            ...
            loss = loss_fn(code_inputs,nl_vec,code_vec) 
            ...
            loss_adv = loss_fn(code_inputs,nl_vec,code_vec) 
...
def main():
    ...
    #build model
    tokenizer = RobertaTokenizer.from_pretrained("DeepSoftwareAnalytics/CoCoSoDa")#(args.model_name_or_path)
    #config = RobertaConfig.from_pretrained(args.model_name_or_path)  ("DeepSoftwareAnalytics/CoCoSoDa")#
    model = RobertaModel.from_pretrained("DeepSoftwareAnalytics/CoCoSoDa")#(args.model_name_or_path) 
